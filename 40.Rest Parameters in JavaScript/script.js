...
function add (...nums){  // here we pass infinity arguments Rest Parameters take that and return us in array.
  console.log(nums)
...
function abc (){ // If we pass the ... here is called as a Rest Parameters and here collect the that values
